...
for (const [nombre, valor] of datos) {
    ...
    resultado[matricula] = valor;
    resultado[terapia] = valor;
...
document.getElementById("matricula").value = resultado["matricula"]
document.getElementById("terapia").value = resultado["terapia"]
